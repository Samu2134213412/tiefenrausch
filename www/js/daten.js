...
export const VERBESSERUNGEN = [
  // --- Antippen ---
  { id: 'griff1', name: 'Verstärkter Greifarm', symbol: 'griff', preis: 100, wirkung: { art: 'tippen', faktor: 2 }, bedingung: { tipps: 10 }, text: 'Doppelter Ertrag pro Antippen.' },
  { id: 'griff2', name: 'Hydraulikgelenk', symbol: 'griff', preis: 2_000, wirkung: { art: 'tippen', faktor: 2 }, bedingung: { tipps: 100 }, text: 'Nochmals doppelter Ertrag pro Antippen.' },
  { id: 'griff3', name: 'Titanklaue', symbol: 'griff', preis: 60_000, wirkung: { art: 'tippen', faktor: 3 }, bedingung: { tipps: 500 }, text: 'Dreifacher Ertrag pro Antippen.' },
  { id: 'resonanz', name: 'Resonanzkammer', symbol: 'resonanz', preis: 500_000, wirkung: { art: 'tippenAnteil', anteil: 0.01 }, bedingung: { tipps: 1000 }, text: 'Antippen gibt zusätzlich 1 % deiner Produktion pro Sekunde.' },
  { id: 'resonanz2', name: 'Tiefenresonanz', symbol: 'resonanz', preis: 50_000_000, wirkung: { art: 'tippenAnteil', anteil: 0.04 }, bedingung: { tipps: 3000 }, text: 'Antippen gibt zusätzlich 4 % deiner Produktion pro Sekunde.' },

  // --- Modul-Verbesserungen (je Modul zwei Stufen) ---
  { id: 'qualle1', name: 'Nährlösung', symbol: 'qualle', preis: 150, wirkung: { art: 'modul', ziel: 'qualle', faktor: 2 }, bedingung: { modul: 'qualle', anzahl: 5 }, text: 'Leuchtquallen leuchten doppelt so hell.' },
  { id: 'qualle2', name: 'Schwarmzucht', symbol: 'qualle', preis: 8_000, wirkung: { art: 'modul', ziel: 'qualle', faktor: 3 }, bedingung: { modul: 'qualle', anzahl: 25 }, text: 'Leuchtquallen dreifach so ergiebig.' },
  { id: 'drohne1', name: 'Feinere Filter', symbol: 'drohne', preis: 1_000, wirkung: { art: 'modul', ziel: 'drohne', faktor: 2 }, bedingung: { modul: 'drohne', anzahl: 5 }, text: 'Sammeldrohnen doppelt so ergiebig.' },
  { id: 'drohne2', name: 'Schwarmsteuerung', symbol: 'drohne', preis: 45_000, wirkung: { art: 'modul', ziel: 'drohne', faktor: 3 }, bedingung: { modul: 'drohne', anzahl: 25 }, text: 'Sammeldrohnen dreifach so ergiebig.' },
  { id: 'sonar1', name: 'Tieferer Puls', symbol: 'sonar', preis: 11_000, wirkung: { art: 'modul', ziel: 'sonar', faktor: 2 }, bedingung: { modul: 'sonar', anzahl: 5 }, text: 'Sonarbojen doppelt so ergiebig.' },
  { id: 'sonar2', name: 'Echokartierung', symbol: 'sonar', preis: 400_000, wirkung: { art: 'modul', ziel: 'sonar', faktor: 3 }, bedingung: { modul: 'sonar', anzahl: 25 }, text: 'Sonarbojen dreifach so ergiebig.' },
  { id: 'roboter1', name: 'Zweiter Greifarm', symbol: 'roboter', preis: 120_000, wirkung: { art: 'modul', ziel: 'roboter', faktor: 2 }, bedingung: { modul: 'roboter', anzahl: 5 }, text: 'Tauchroboter doppelt so ergiebig.' },
  { id: 'roboter2', name: 'Autonomes Denken', symbol: 'roboter', preis: 4_000_000, wirkung: { art: 'modul', ziel: 'roboter', faktor: 3 }, bedingung: { modul: 'roboter', anzahl: 25 }, text: 'Tauchroboter dreifach so ergiebig.' },
  { id: 'farm1', name: 'Wärmekreislauf', symbol: 'farm', preis: 1_300_000, wirkung: { art: 'modul', ziel: 'farm', faktor: 2 }, bedingung: { modul: 'farm', anzahl: 5 }, text: 'Plankton-Farmen doppelt so ergiebig.' },
  { id: 'farm2', name: 'Zuchtauswahl', symbol: 'farm', preis: 40_000_000, wirkung: { art: 'modul', ziel: 'farm', faktor: 3 }, bedingung: { modul: 'farm', anzahl: 25 }, text: 'Plankton-Farmen dreifach so ergiebig.' },
  { id: 'schlot1', name: 'Druckturbine', symbol: 'schlot', preis: 14_000_000, wirkung: { art: 'modul', ziel: 'schlot', faktor: 2 }, bedingung: { modul: 'schlot', anzahl: 5 }, text: 'Thermalschlot-Reaktoren doppelt so ergiebig.' },
  { id: 'riff1', name: 'Symbiosepilze', symbol: 'riff', preis: 200_000_000, wirkung: { art: 'modul', ziel: 'riff', faktor: 2 }, bedingung: { modul: 'riff', anzahl: 5 }, text: 'Kolonie-Riffe doppelt so ergiebig.' },
  { id: 'station1', name: 'Schichtbetrieb', symbol: 'station', preis: 3_300_000_000, wirkung: { art: 'modul', ziel: 'station', faktor: 2 }, bedingung: { modul: 'station', anzahl: 5 }, text: 'Abgrund-Stationen doppelt so ergiebig.' },

  // --- Globale Verbesserungen ---
  { id: 'global1', name: 'Kaltlichtlampen', symbol: 'gluehbirne', preis: 25_000, wirkung: { art: 'global', faktor: 1.25 }, bedingung: { module: 25 }, text: 'Alle Module +25 %.' },
  { id: 'global2', name: 'Druckausgleich', symbol: 'gear', preis: 900_000, wirkung: { art: 'global', faktor: 1.5 }, bedingung: { module: 75 }, text: 'Alle Module +50 %.' },
  { id: 'global3', name: 'Strömungskarte', symbol: 'karte', preis: 30_000_000, wirkung: { art: 'global', faktor: 1.5 }, bedingung: { module: 150 }, text: 'Alle Module +50 %.' },
  { id: 'global4', name: 'Abyssal-Netzwerk', symbol: 'netz', preis: 900_000_000, wirkung: { art: 'global', faktor: 2 }, bedingung: { module: 250 }, text: 'Alle Module verdoppelt.' },
];
...
export const ENTDECKUNGEN = [
  { tiefe: 5, name: 'Schwarmhering', symbol: 'schwarmhering', bonus: 1.05, text: 'Noch im Licht von oben. Silbrige Leiber, die sich wie ein einziges Tier bewegen.' },
  { tiefe: 15, name: 'Segelquale', symbol: 'qualle', bonus: 1.05, text: 'Treibt an der Oberfläche wie ein vergessener Luftballon. Besser nicht anfassen.' },
  { tiefe: 35, name: 'Laternenfisch', symbol: 'laterne', bonus: 1.08, text: 'Trägt seine eigene Lampe unter dem Auge. Der erste echte Bewohner des Zwielichts.' },
  { tiefe: 70, name: 'Riesenkalmar', symbol: 'kalmar', bonus: 1.1, text: 'Acht Arme, zwei Tentakel, kein Interesse an dir. Vorerst.' },
  { tiefe: 130, name: 'Vampirtintenfisch', symbol: 'vampirtinte', bonus: 1.12, text: 'Lebt dort, wo kaum Sauerstoff ist, und stülpt sich bei Gefahr einfach um.' },
  { tiefe: 250, name: 'Anglerfisch', symbol: 'angler', bonus: 1.15, text: 'Die Angel leuchtet. Das Maul kommt später. Alles hier unten ist eine Falle.' },
  { tiefe: 450, name: 'Pelikanaal', symbol: 'pelikanaal', bonus: 1.18, text: 'Fast nur Maul. Verschlingt Beute, die größer ist als er selbst.' },
  { tiefe: 800, name: 'Schlangenstern-Feld', symbol: 'seestern', bonus: 1.2, text: 'Der Boden bewegt sich. Er besteht aus Armen, so weit die Scheinwerfer reichen.' },
  { tiefe: 1_400, name: 'Kolossaler Krake', symbol: 'krake', bonus: 1.25, text: 'Ein Auge so groß wie ein Teller sieht dich an und entscheidet sich gegen dich.' },
  { tiefe: 2_500, name: 'Geisterhai', symbol: 'hai', bonus: 1.3, text: 'Älter als Bäume. Schwimmt, als hätte er alle Zeit der Welt. Hat er auch.' },
  { tiefe: 4_000, name: 'Thermalgarten', symbol: 'thermal', bonus: 1.35, text: 'Leben ohne Sonne, gespeist aus Hitze und Schwefel. Ein zweiter Anfang der Welt.' },
  { tiefe: 6_500, name: 'Abgrunddrache', symbol: 'drache', bonus: 1.4, text: 'Sein Leuchten ist rot. Rot dringt hier unten am wenigsten weit – das weiß nur er.' },
  { tiefe: 11_000, name: 'Grund des Grabens', symbol: 'abgrund', bonus: 1.5, text: 'Tiefster bekannter Punkt. Ein Plastikbeutel liegt hier. Natürlich.' },
  { tiefe: 18_000, name: 'Der Riss', symbol: 'blitzriss', bonus: 1.75, text: 'Auf keiner Karte. Das Sonar gibt kein Echo zurück. Du tauchst trotzdem weiter.' },
  { tiefe: 30_000, name: 'Etwas, das wartet', symbol: 'auge', bonus: 2, text: 'Es hat sich nicht bewegt, seit du hier bist. Es hat sich nie bewegt. Es schaut.' },
];

/** Erfolge: kleine Ziele, die Fortschritt sichtbar machen. */
export const ERFOLGE = [
  { id: 'erstertipp', name: 'Erster Kontakt', symbol: 'tipp', text: 'Tippe zum ersten Mal.', pruef: (z) => z.tipps >= 1 },
  { id: 'hundert', name: 'Handarbeit', symbol: 'tipp', text: 'Tippe 100-mal.', pruef: (z) => z.tipps >= 100 },
  { id: 'tausend', name: 'Sehnenscheide', symbol: 'tipp', text: 'Tippe 1.000-mal.', pruef: (z) => z.tipps >= 1000 },
  { id: 'erstesmodul', name: 'Inbetriebnahme', symbol: 'wrench', text: 'Kaufe dein erstes Modul.', pruef: (z) => gesamtModule(z) >= 1 },
  { id: 'zehnmodule', name: 'Kleine Station', symbol: 'fabrik', text: 'Besitze 10 Module.', pruef: (z) => gesamtModule(z) >= 10 },
  { id: 'hundertmodule', name: 'Industriegebiet', symbol: 'fabrik', text: 'Besitze 100 Module.', pruef: (z) => gesamtModule(z) >= 100 },
  { id: 'tiefe100', name: 'Zwielicht', symbol: 'welle', text: 'Erreiche 100 m Tiefe.', pruef: (z) => z.maxTiefe >= 100 },
  { id: 'tiefe1000', name: 'Mitternachtszone', symbol: 'abgrund', text: 'Erreiche 1.000 m Tiefe.', pruef: (z) => z.maxTiefe >= 1000 },
  { id: 'tiefe11000', name: 'Am Grund', symbol: 'abgrund', text: 'Erreiche 11.000 m Tiefe.', pruef: (z) => z.maxTiefe >= 11000 },
  { id: 'ersteperle', name: 'Aufgetaucht', symbol: 'blase', text: 'Tauche zum ersten Mal auf.', pruef: (z) => z.aufstiege >= 1 },
  { id: 'zehnperlen', name: 'Perlensammler', symbol: 'perlenauster', text: 'Besitze 10 Perlen.', pruef: (z) => z.perlen >= 10 },
  { id: 'hundertperlen', name: 'Perlenkette', symbol: 'perlenauster', text: 'Besitze 100 Perlen.', pruef: (z) => z.perlen >= 100 },
  { id: 'allesgesehen', name: 'Logbuch voll', symbol: 'buch', text: 'Entdecke alle Kreaturen.', pruef: (z) => z.entdeckungen.length >= ENTDECKUNGEN.length },
  { id: 'kombo10', name: 'Kettenreaktion', symbol: 'kette', text: 'Erreiche eine Kombo von 10.', pruef: (z) => (z.komboMax ?? 0) >= 10 },
  { id: 'kombo25', name: 'Außer Kontrolle', symbol: 'spirale', text: 'Erreiche eine Kombo von 25.', pruef: (z) => (z.komboMax ?? 0) >= 25 },
  { id: 'krit1', name: 'Volltreffer', symbol: 'funke', text: 'Lande deinen ersten kritischen Treffer.', pruef: (z) => (z.kritischeTreffer ?? 0) >= 1 },
  { id: 'krit100', name: 'Scharfschütze', symbol: 'funke', text: 'Lande 100 kritische Treffer.', pruef: (z) => (z.kritischeTreffer ?? 0) >= 100 },
  { id: 'blase1', name: 'Aufmerksam', symbol: 'glitzer', text: 'Sammle deine erste Leuchtblase ein.', pruef: (z) => (z.leuchtblasenGesammelt ?? 0) >= 1 },
  { id: 'blase20', name: 'Perlenfischer', symbol: 'glitzer', text: 'Sammle 20 Leuchtblasen ein.', pruef: (z) => (z.leuchtblasenGesammelt ?? 0) >= 20 },
  { id: 'fisch1', name: 'Petri Heil', symbol: 'fisch', text: 'Fange deinen ersten Glücksfisch.', pruef: (z) => (z.gluecksfischeGefangen ?? 0) >= 1 },
  { id: 'fisch15', name: 'Angelglück', symbol: 'angel', text: 'Fange 15 Glücksfische.', pruef: (z) => (z.gluecksfischeGefangen ?? 0) >= 15 },
  { id: 'kiste1', name: 'Ausgepackt', symbol: 'kiste', text: 'Öffne deine erste Kiste.', pruef: (z) => (z.kistenGeoeffnet ?? 0) >= 1 },
  { id: 'kiste10', name: 'Sammelleidenschaft', symbol: 'geschenk', text: 'Öffne 10 Kisten.', pruef: (z) => (z.kistenGeoeffnet ?? 0) >= 10 },
  { id: 'ausgeruestet1', name: 'Startklar', symbol: 'angel', text: 'Rüste deine erste Angel aus.', pruef: (z) => z.ausruestung?.angel != null },
  { id: 'legendaerItem', name: 'Aus der Tiefe', symbol: 'stern', text: 'Besitze ein legendäres Ausrüstungsteil.', pruef: (z) => (z.besitzItems ?? []).some((id) => findeItem(id)?.seltenheit === 'legendaer') },
  { id: 'expedition1', name: 'Losgeschickt', symbol: 'boot', text: 'Schließe deine erste Expedition ab.', pruef: (z) => (z.expeditionenAbgeschlossen ?? 0) >= 1 },
  { id: 'expedition10', name: 'Vielgereist', symbol: 'boot', text: 'Schließe 10 Expeditionen ab.', pruef: (z) => (z.expeditionenAbgeschlossen ?? 0) >= 10 },
  { id: 'aquarium1', name: 'Neuer Mitbewohner', symbol: 'fisch', text: 'Fange deinen ersten Aquarium-Fisch.', pruef: (z) => (z.aquarium ?? []).length >= 1 },
  { id: 'aquariumvoll', name: 'Vollbesetzt', symbol: 'wal', text: 'Fülle das gesamte Aquarium.', pruef: (z) => (z.aquarium ?? []).length >= AQUARIUM_FISCHE.length },
  { id: 'tagestruhe1', name: 'Wiederkehrer', symbol: 'truhe', text: 'Hole dir deine erste Tages-Truhe.', pruef: (z) => (z.tagesStreak ?? 0) >= 1 },
  { id: 'streak7', name: 'Feste Gewohnheit', symbol: 'flamme', text: 'Hole die Tages-Truhe 7 Tage in Folge.', pruef: (z) => (z.tagesStreak ?? 0) >= 7 },
  { id: 'gluecksrad1', name: 'Erste Drehung', symbol: 'rad', text: 'Dreh zum ersten Mal am Glücksrad.', pruef: (z) => (z.gluecksradGedreht ?? 0) >= 1 },
  { id: 'gluecksrad30', name: 'Radfahrer', symbol: 'rad', text: 'Dreh 30-mal am Glücksrad.', pruef: (z) => (z.gluecksradGedreht ?? 0) >= 30 },
];
 ...
 */
export const ITEMS = [
  { id: 'angel_holz', slot: 'angel', name: 'Hölzerne Angel', symbol: 'angel', seltenheit: 'gewoehnlich',
    zeitFaktor: 0.92, fundChance: 0.12, text: 'Reicht gerade so, um überhaupt loszufahren.' },
  { id: 'angel_stahl', slot: 'angel', name: 'Stahlangel', symbol: 'angel', seltenheit: 'selten',
    zeitFaktor: 0.80, fundChance: 0.20, text: 'Hält auch größerem Zug stand.' },
  { id: 'angel_leucht', slot: 'angel', name: 'Leuchtangel', symbol: 'angel', seltenheit: 'episch',
    zeitFaktor: 0.62, fundChance: 0.32, text: 'Lockt mit eigenem Licht, was sonst nie an die Oberfläche käme.' },
  { id: 'angel_abgrund', slot: 'angel', name: 'Abgrundangel', symbol: 'angel', seltenheit: 'legendaer',
    zeitFaktor: 0.42, fundChance: 0.50, text: 'Niemand weiß, aus welchem Metall sie gefertigt ist.' },

  { id: 'koeder_wurm', slot: 'koeder', name: 'Wattwurm', symbol: 'wurm', seltenheit: 'gewoehnlich',
    blFaktor: 1.15, fundBonus: 0.03, text: 'Der Klassiker. Funktioniert einfach.' },
  { id: 'koeder_glitzer', slot: 'koeder', name: 'Glitzerköder', symbol: 'glitzerkoeder', seltenheit: 'selten',
    blFaktor: 1.35, fundBonus: 0.05, text: 'Reflektiert jedes bisschen Licht, das es gibt.' },
  { id: 'koeder_pheromon', slot: 'koeder', name: 'Pheromonköder', symbol: 'flaeschchen', seltenheit: 'episch',
    blFaktor: 1.65, fundBonus: 0.08, text: 'Riecht nach etwas, das man lieber nicht genau wissen möchte.' },
  { id: 'koeder_essenz', slot: 'koeder', name: 'Abyssal-Essenz', symbol: 'essenz', seltenheit: 'legendaer',
...
export const KISTEN_TYPEN = [
  { id: 'holz', name: 'Holzkiste', symbol: 'kiste',
    gewichte: { gewoehnlich: 70, selten: 25, episch: 5, legendaer: 0 } },
  { id: 'silber', name: 'Silberkiste', symbol: 'geschenk',
    gewichte: { gewoehnlich: 38, selten: 40, episch: 19, legendaer: 3 } },
  { id: 'gold', name: 'Goldkiste', symbol: 'pokal',
...
export const EXPEDITIONEN = [
  { id: 'kurz', name: 'Kurzer Streifzug', symbol: 'boot', dauerMs: 5 * 60 * 1000,
  ...
  { id: 'mittel', name: 'Tauchgang', symbol: 'boot', dauerMs: 30 * 60 * 1000,
  ...
  { id: 'lang', name: 'Tiefseeexpedition', symbol: 'boot', dauerMs: 3 * 60 * 60 * 1000,
  ...
  { id: 'wagnis', name: 'Wagnis in den Abgrund', symbol: 'abgrund', dauerMs: 8 * 60 * 60 * 1000,
...
export const EXPEDITIONS_EREIGNISSE = [
  { id: 'sturm', symbol: 'welle', name: 'Sturm zieht auf',
  ...
  { id: 'strudel', symbol: 'spirale', name: 'Strudel in der Tiefe',
...
export const AQUARIUM_FISCHE = [
  { id: 'clownfisch', name: 'Clownfisch', symbol: 'fisch', seltenheit: 'gewoehnlich', bonus: 1.01,
    text: 'Quietschbunt und voellig fehl am Platz hier unten. Schwimmt trotzdem munter mit.' },
  { id: 'kugelfisch', name: 'Kugelfisch', symbol: 'kugelfisch', seltenheit: 'gewoehnlich', bonus: 1.01,
    text: 'Bläht sich auf, sobald die Angel in der Nähe ist.' },
  { id: 'seepferdchen', name: 'Seepferdchen', symbol: 'seepferdchen', seltenheit: 'gewoehnlich', bonus: 1.015,
    text: 'Hält sich mit dem Schwanz an allem fest, was nicht wegschwimmt.' },
  { id: 'languste', name: 'Languste', symbol: 'languste', seltenheit: 'selten', bonus: 1.02,
    text: 'Geht rückwärts, wenn es brenzlig wird. Ziemlich oft, muss man sagen.' },
  { id: 'tintenfisch', name: 'Zwergtintenfisch', symbol: 'kalmar', seltenheit: 'selten', bonus: 1.025,
    text: 'Wechselt die Farbe schneller, als man hinsehen kann.' },
  { id: 'schildkroete', name: 'Meeresschildkröte', symbol: 'schildkroete', seltenheit: 'selten', bonus: 1.03,
    text: 'Uralt, gelassen, völlig unbeeindruckt von der ganzen Station.' },
  { id: 'muraene', name: 'Muräne', symbol: 'muraene', seltenheit: 'episch', bonus: 1.05,
    text: 'Wartet reglos in einer Spalte, bis irgendwas Interessantes vorbeikommt.' },
  { id: 'mantarochen', name: 'Mantarochen', symbol: 'mantarochen', seltenheit: 'episch', bonus: 1.06,
    text: 'Gleitet wie ein Schatten über die Station hinweg, ohne sie zu berühren.' },
  { id: 'perlenauster', name: 'Perlenauster', symbol: 'perlenauster', seltenheit: 'episch', bonus: 1.07,
    text: 'Braucht Jahre für eine einzige Perle. Hier unten hat sie davon reichlich.' },
  { id: 'nautilus', name: 'Perlboot', symbol: 'nautilus', seltenheit: 'legendaer', bonus: 1.12,
    text: 'Lebt fast unverändert seit Jahrmillionen. Es hatte offenbar keine Eile.' },
  { id: 'zitterrochen', name: 'Zitterrochen', symbol: 'zitterrochen', seltenheit: 'legendaer', bonus: 1.15,
...
export const PERLEN_SHOP = [
  { id: 'kopfstart', name: 'Kopfstart', symbol: 'rakete', preis: 8,
  ...
  { id: 'kombogeduld', name: 'Ruhiger Atem', symbol: 'atemzug', preis: 15,
  ...
  { id: 'offlinebonus', name: 'Ruhige Tiefe', symbol: 'mond', preis: 25,
    text: 'Offline wird dauerhaft 20 Prozentpunkte mehr gesammelt.',
    wirkung: { art: 'offlineAnteilBonus', wert: 0.2 } },
  { id: 'kistenglueck', name: 'Glückssträhne', symbol: 'klee', preis: 50,
...
export const GLUECKSRAD_SEGMENTE = [
  { id: 'bl_klein', symbol: 'tropfen', farbe: '#4fe3d0', gewicht: 30, art: 'bl', sekundenwert: 60,
    text: 'Eine kleine Menge Biolumineszenz.' },
  { id: 'kiste_holz', symbol: 'kiste', farbe: '#a97c50', gewicht: 16, art: 'kiste', kistenTyp: 'holz',
    text: 'Eine Holzkiste für den Vorrat.' },
  { id: 'bl_mittel', symbol: 'diamant', farbe: '#2fb3a3', gewicht: 20, art: 'bl', sekundenwert: 180,
    text: 'Eine ordentliche Portion Biolumineszenz.' },
  { id: 'boost_kurz', symbol: 'blitzriss', farbe: '#ffb454', gewicht: 15, art: 'boost', dauerMs: 5 * 60 * 1000,
    text: '5 Minuten doppelte Ausbeute.' },
  { id: 'kiste_silber', symbol: 'geschenk', farbe: '#9db3c4', gewicht: 9, art: 'kiste', kistenTyp: 'silber',
    text: 'Eine Silberkiste für den Vorrat.' },
  { id: 'bl_gross', symbol: 'stern', farbe: '#ffd9a0', gewicht: 5, art: 'bl', sekundenwert: 600,
    text: 'Ein großer Fund!' },
  { id: 'perlen', symbol: 'blase', farbe: '#b98bff', gewicht: 3, art: 'perlen', anzahl: 2,
    text: '2 Perlen, direkt geschenkt.' },
  { id: 'kiste_gold', symbol: 'pokal', farbe: '#f0b429', gewicht: 2, art: 'kiste', kistenTyp: 'gold',
